<?php
	...
	if (isset($_POST['email'])) {
		...
		//sprawdzenie poprawnosci nick'u
		$nick = $_POST['nick'];

		//sprawdzenie długości nicka
		if (strlen($nick)<3 || (strlen($nick)>20)) {
			$wszystko_OK=false;
			$_SESSION['e_nick']="Login musi składać się z 3 do 20 znaków!";
		}
		...
		$sekret = "6LcO9u8ZAAAAADCTCk_PsoSPaQHgfddLv37B97ZZ";
		...
		try{
			...
			if ($polaczenie->connect_errno!=0)
			{
				...
				if ($ile_takich_nickow>0) {
					$wszystko_OK=false;
					$_SESSION['e_nick']="istnieje już taki uzytkownik o takim nicku. Wybierz inny!";
				}
...
<head>
	...
	<title>E-budowa - załóż darmowe konto</title>
...
<div class="wrapper row1">
      ...
      <ul class="clear">
        <li><a href="zaloguj1.php">Zaloguj</a></li>
      </ul>
    </nav>
	  </header>
</div>
...
<div id="login">
	<form method="post">
		...
		<div class="g-recaptcha" data-sitekey="6LcO9u8ZAAAAAGubsE34ogDCZ_weabdO6TWAC5yb"></div>
		<?php
